...
- Bad: "I think climate policy is important"
- Good: "Hot take: Current climate policy ignores nuclear energy. Thoughts?" (triggers replies)
...
**Example Optimization**:
- Bad: "I use many programming languages"
- Good: "Rust's ownership system is the most underrated feature. Here's why..." (targets specific dev community)
...
**Example Optimization**:
- Bad: "I like lots of things" (vague, confuses algorithm)
- Good: "My 3rd consecutive framework review as a full-stack engineer" (establishes authority)
...
**Example Optimization**:
- Bad: "RETWEET IF..." (engagement bait, damages credibility over time)
- Good: "Thoughtful critique of the approach in [linked tweet]" (builds authority)
...
**Example Optimization**:
- Bad: "Check out this tool" (passive)
- Good: "This tool saved me 5 hours this week. Here's how to set it up..." (actionable, retweet-worthy)
